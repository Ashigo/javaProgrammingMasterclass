public class PlayingCat {
    ...
    //  is between 25 and 35 (inclusive). Unless it is summer, then the upper limit is 45 (inclusive) instead of 35.
    ...
    public static boolean isCatPlaying(boolean summer, int temperature) {
        ...
        return (temperature >= lowerTemp && temperature <= higherTemp);
    }
}
